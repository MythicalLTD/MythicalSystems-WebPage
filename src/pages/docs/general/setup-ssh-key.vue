            ...
            <div class="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
                <div class="space-y-8">
                    <Card title="Generating SSH Keys">
                        ...
                        <br />
                        <p class="mb-4">
                            2. When prompted, specify the file where you want to save the key (default is
                    ...
                    <Card title="Saving and Using SSH Keys">
                        ...
                        <br />
                        <p class="mb-4">
                            2. Verify that the key has been added to the <code>~/.ssh/authorized_keys</code> file on the
                            remote server:
                        </p>
                    ...
                    <Card title="Configuring SSH to Use SSH Keys Only and Disable Root Password Login">
                        <p class="mb-4">
                            To configure SSH to use SSH keys only and disable root login with a password, follow the
                            steps below:
                        </p>
